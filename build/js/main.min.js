...
/* harmony import */ var _modules_header_locomotive_scroll__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/header/locomotive-scroll */ "./js/modules/header/locomotive-scroll.js");
/* harmony import */ var _modules_header_burger__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/header/burger */ "./js/modules/header/burger.js");
/* harmony import */ var _modules_header_sticky_header__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/header/sticky-header */ "./js/modules/header/sticky-header.js");
/* harmony import */ var _modules_header_init_locomotive_scroll__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/header/init-locomotive-scroll */ "./js/modules/header/init-locomotive-scroll.js");
/* harmony import */ var _modules_modals_map__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/modals/map */ "./js/modules/modals/map.js");
...
var navMenu = document.querySelector('.main-header');
navMenu.classList.remove('main-header--no-js');
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_header_init_locomotive_scroll__WEBPACK_IMPORTED_MODULE_6__["initLocomotiveScroll"])();
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    var burger = new _modules_header_burger__WEBPACK_IMPORTED_MODULE_4__["Burger"]();
    burger.init();
    var stickyHeader = new _modules_header_sticky_header__WEBPACK_IMPORTED_MODULE_5__["StickyHeader"]();
    stickyHeader.init();
    _modules_modals_map__WEBPACK_IMPORTED_MODULE_7__["ymaps"].ready(_modules_modals_map__WEBPACK_IMPORTED_MODULE_7__["init"]);
  });
});
...
/* harmony import */ var _ios_checker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ios-checker */ "./js/modules/header/ios-checker.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
function init() {
  ...
  var placemark = new ymaps.Placemark(cent, {}, {
